...
.dropdown a:hover {background-color: #ddd}
	...
	<div class="dropdown">
                                     ...
                                     <button onclick="myFunction()" class="dropbtn"><a href="Updateprofile.jsp?name=<%=name%>">Update Profile</a></button>
			...
			<div class="row">
				...
				<div class="col-md-6 mt-sm">
					...
					<div class="feature-left animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="feature-copy">
							<p style="font-size:20px;">State : 
							<%=rs.getString("state")%></p>
						</div>
					</div>
					...
					<div class="feature-left animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="feature-copy">
							<p style="font-size:20px;">Education :
							<%=rs.getString("education")%></p>
						</div>
					</div>
					...
					<div class="feature-left animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="feature-copy">
							<p style="font-size:20px;">Interest :
							<%=rs.getString("interest")%></p>
						</div>
					</div>
					...
					<div class="feature-left animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="feature-copy">
							<p style="font-size:20px;">Hobbies :
							<%=rs.getString("hobby")%></p>
						</div>
					</div>
